            ...
            <div class="col-md-6 col-12">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="nav-konijnen" role="tabpanel" aria-labelledby="nav-konijnen-tab">
                        <p>
                        In tegenstelling tot wat vaak wordt gedacht, zijn konijnen <strong> geen goede huisdieren voor kinderen</strong>. De meeste konijnen vinden oppakken en knuffelen niet leuk. Ze kunnen dan krabben en bijten en <em> zelfs hun eigen rug breken</em> als ze spartelen bij het optillen. 
                        <p>
                        Door veel tijd aan het konijn te besteden en er rustig mee om te gaan, kan het wel tam worden en leren dat aaien prettig kan zijn. Konijnen kunnen ook allerlei trucjes leren en er wordt zelfs aan konijnen-agility gedaan. <em> Konijnen zijn dus vooral leuke huisdieren voor mensen die er ofwel veel mee willen bezig zijn, ofwel er vooral willen naar kijken.</em></p>
                        </p>
                        <p>
                    ...
                    <div class="tab-pane fade" id="nav-kippen" role="tabpanel" aria-labelledby="nav-kippen-tab">
                        ...
                        <p>
                        Om de kippen te vervoeren, kan je een speciaal kippenkrat gebruiken of een stevige kartonnen doos met luchtgaten. Zo kunnen de kippen veilig en rustig vervoerd worden. Zet de doos goed vast in de auto, zodat deze niet aan het schuiven gaat. Kippen geraken snel oververhit. Transporteer ze dus niet op warme dagen en zorg voor voldoende ventilatie.
                        </p>
                        <p>
                        Richt het hok en de ren in voordat je de kippen koopt. Zet de kippen bij aankomst in het binnenhok en laat hen zelf de weg naar buiten ontdekken. Geef in het begin hetzelfde voer als de vorige eigenaar en wen ze geleidelijk aan nieuw voer. 
                        </p>
                    </div>
                    <div class="tab-pane fade" id="nav-paarden" role="tabpanel" aria-labelledby="nav-paarden-tab">
                        <p>
                        Paarden zijn kuddedieren die bij voorkeur in een kleine kudde leven. Andere dieren, zoals geiten of ezels, kunnen ook op dezelfde weide staan, maar ze vervangen het gezelschap van een ander paard niet.</p>
                        <p>
